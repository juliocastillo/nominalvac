...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'sonata.admin.estado' => 'getSonata_Admin_EstadoService',
            ...
            'sonata.admin.vacuna' => 'getSonata_Admin_VacunaService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => 'localhost', 'port' => 5432, 'dbname' => 'nominalvacdb', 'user' => 'nominalvac', 'password' => 'nominalvac', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Minsal/CatalogoBundle/Entity'))), 'Minsal\\CatalogoBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('MinsalCatalogoBundle' => 'Minsal\\CatalogoBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_57799e3703c7c85b9f12ce9054375ec3edbf03ad4a3ce68c9df39e47fca4ea07');
    ...
    /**
     * Gets the 'sonata.admin.estado' service.
     *
     * @return \Minsal\CatalogoBundle\Admin\EstadoAdmin A Minsal\CatalogoBundle\Admin\EstadoAdmin instance.
     */
    protected function getSonata_Admin_EstadoService()
    {
        $instance = new \Minsal\CatalogoBundle\Admin\EstadoAdmin('sonata.admin.estado', 'Minsal\\CatalogoBundle\\Entity\\Estado', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('MinsalCatalogoBundle');
    ...
    {
        $this->services['sonata.admin.pool'] = $instance = new \Sonata\AdminBundle\Admin\Pool($this, 'Nominal-vac v 03.24.15', '/bundles/minsalcatalogo/images/dtic.png', array('html5_validate' => true, 'confirm_exit' => true, 'use_select2' => true, 'use_icheck' => true, 'pager_links' => NULL, 'form_type' => 'standard', 'dropdown_number_groups_per_colums' => 2, 'title_mode' => 'both', 'javascripts' => array(0 => 'bundles/sonatacore/vendor/jquery/dist/jquery.min.js', 1 => 'bundles/sonataadmin/vendor/jquery.scrollTo/jquery.scrollTo.min.js', 2 => 'bundles/sonatacore/vendor/moment/min/moment.min.js', 3 => 'bundles/sonatacore/vendor/bootstrap/dist/js/bootstrap.min.js', 4 => 'bundles/sonatacore/vendor/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js', 5 => 'bundles/sonataadmin/vendor/jqueryui/ui/minified/jquery-ui.min.js', 6 => 'bundles/sonataadmin/vendor/jqueryui/ui/minified/i18n/jquery-ui-i18n.min.js', 7 => 'bundles/sonataadmin/jquery/jquery.form.js', 8 => 'bundles/sonataadmin/jquery/jquery.confirmExit.js', 9 => 'bundles/sonataadmin/vendor/x-editable/dist/bootstrap3-editable/js/bootstrap-editable.min.js', 10 => 'bundles/sonatacore/vendor/select2/select2.min.js', 11 => 'bundles/sonataadmin/vendor/admin-lte/dist/js/app.min.js', 12 => 'bundles/sonataadmin/vendor/iCheck/icheck.min.js', 13 => 'bundles/sonataadmin/vendor/slimScroll/jquery.slimscroll.min.js', 14 => 'bundles/sonataadmin/Admin.js', 15 => 'bundles/sonataadmin/treeview.js'), 'stylesheets' => array(0 => 'bundles/sonatacore/vendor/bootstrap/dist/css/bootstrap.min.css', 1 => 'bundles/sonatacore/vendor/components-font-awesome/css/font-awesome.min.css', 2 => 'bundles/sonatacore/vendor/ionicons/css/ionicons.min.css', 3 => 'bundles/sonataadmin/vendor/admin-lte/dist/css/AdminLTE.min.css', 4 => 'bundles/sonataadmin/vendor/admin-lte/dist/css/skins/skin-black.min.css', 5 => 'bundles/sonataadmin/vendor/iCheck/skins/flat/blue.css', 6 => 'bundles/sonatacore/vendor/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css', 7 => 'bundles/sonataadmin/vendor/jqueryui/themes/base/jquery-ui.css', 8 => 'bundles/sonatacore/vendor/select2/select2.css', 9 => 'bundles/sonatacore/vendor/select2-bootstrap-css/select2-bootstrap.min.css', 10 => 'bundles/sonataadmin/vendor/x-editable/dist/bootstrap3-editable/css/bootstrap-editable.css', 11 => 'bundles/sonataadmin/css/styles.css', 12 => 'bundles/sonataadmin/css/layout.css', 13 => 'bundles/sonataadmin/css/tree.css')), array());
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.vacuna', 1 => 'sonata.admin.estado'));
        $instance->setAdminGroups(array('Entidades' => array('label' => 'Entidades', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => array('admin' => 'sonata.admin.vacuna', 'label' => '', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'sonata.admin.estado', 'label' => '', 'route' => '', 'route_params' => array())))));
        $instance->setAdminClasses(array('Minsal\\CatalogoBundle\\Entity\\Vacuna' => array(0 => 'sonata.admin.vacuna'), 'Minsal\\CatalogoBundle\\Entity\\Estado' => array(0 => 'sonata.admin.estado')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.vacuna', 1 => 'sonata.admin.estado'), $this);
    }
    ...
    /**
     * Gets the 'sonata.admin.vacuna' service.
     *
     * @return \Minsal\CatalogoBundle\Admin\VacunaAdmin A Minsal\CatalogoBundle\Admin\VacunaAdmin instance.
     */
    protected function getSonata_Admin_VacunaService()
    {
        $instance = new \Minsal\CatalogoBundle\Admin\VacunaAdmin('sonata.admin.vacuna', 'Minsal\\CatalogoBundle\\Entity\\Vacuna', 'SonataAdminBundle:CRUD');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Minsal/CatalogoBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Minsal/CatalogoBundle/Resources/views'), 'MinsalCatalogo');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2cf52daab3f40d1c6500778d6a0dc49acc3b0cce');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MinsalCatalogoBundle' => 'Minsal\\CatalogoBundle\\MinsalCatalogoBundle',
            ...
            'database_port' => 5432,
            'database_name' => 'nominalvacdb',
            'database_user' => 'nominalvac',
            'database_password' => 'nominalvac',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'es',
            'secret' => '2cf52daab3f40d1c6500778d6a0dc49acc3b0cce',
            ...
            'kernel.secret' => '2cf52daab3f40d1c6500778d6a0dc49acc3b0cce',
